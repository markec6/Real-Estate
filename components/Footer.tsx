/* Pure Server Component — hover states are CSS-driven */
...
export default function Footer() {
  return (
    <footer className="footer-section" aria-label="Podnožje stranice">
      <div className="footer-container">
        ...
        <div className="footer-main">
          ...
          <div className="footer-brand">
            <a href="#" className="footer-logo">
              ...
              <span className="footer-logo-title">Balkan Real Estate Intelligence</span>
            </a>
            <p className="footer-pitch">
              Automatizovana pretraga i AI analiza izvornih oglasa na Balkanu.
            </p>
          </div>
        ...
        <div className="footer-bottom">
          <p className="footer-copyright">
            &copy; 2026 Balkan Real Estate. Sva prava zadržana.
          </p>
